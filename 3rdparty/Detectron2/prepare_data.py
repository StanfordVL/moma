...
def register_datasets(moma, kind=None):
  """
  ...
  DatasetCatalog.register('moma_train', lambda: create_dataset(moma, ids_hoi_train, kind, cname_to_cid))
  DatasetCatalog.register('moma_val', lambda: create_dataset(moma, ids_hoi_val, kind, cname_to_cid))
